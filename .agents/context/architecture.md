...
Google Nearby / GMS. Single Gradle module `:app`, package `app.swarsetu`, minSdk 29 / targetSdk 36 /
...
ui/            Compose screens (onboarding, chatlist, chat, contacts, profile, group, diagnostics,
               blocked, share, donate) + ViewModels (Koin koinViewModel()) · SwarSetuApp (Navigation Compose)
