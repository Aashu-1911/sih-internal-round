...
import app.swarsetu.demo.DemoDirector
import app.swarsetu.demo.DemoSeeder
import app.swarsetu.mesh.DemoTransport
 ...
 *
 * `src/main` calls these three seams (`di/MeshModule.kt` for the transport, `SwarSetuApplication` for the seed
 ...
 * so the lazily-built transport and the director (started from SwarSetuApplication) share the one instance.
 */
