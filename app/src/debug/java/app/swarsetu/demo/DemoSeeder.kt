 ...
 * so both stay in lockstep. Paired with [app.swarsetu.mesh.DemoTransport], which reports
...
class DemoSeeder(
    ...
    companion object {
        ...
        /** The subset of demo peers reported as connected by [app.swarsetu.mesh.DemoTransport]. */
