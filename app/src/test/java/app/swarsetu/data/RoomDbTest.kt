 ...
 *
 * It builds [MeshDatabase] with [Room.inMemoryDatabaseBuilder], which — unlike the production
 * [MeshDatabase.build] — installs **no** SQLCipher `openHelperFactory`, so it runs on Robolectric's framework
...
abstract class RoomDbTest {
    protected lateinit var db: MeshDatabase
