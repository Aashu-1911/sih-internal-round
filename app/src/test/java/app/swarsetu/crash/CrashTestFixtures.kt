...
internal fun throwableWith(message: String): Throwable =
    IllegalStateException(message).apply {
        stackTrace =
            arrayOf(
                StackTraceElement("app.swarsetu.mesh.bluetooth.BluetoothMeshTransport", "hello", "BluetoothMeshTransport.kt", 552),
                StackTraceElement("app.swarsetu.mesh.MeshRouter", "route", "MeshRouter.kt", 91),
            )
    }
