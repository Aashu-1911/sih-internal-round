...
object Protocol {
     ...
     * ([app.swarsetu.data.forward.ForwardRepository.store]) so it can't become un-sweepable and win
     ...
     * ([app.swarsetu.mesh.InboundPipeline.deliverChat]) so a future-dated frame can't pin itself to the
