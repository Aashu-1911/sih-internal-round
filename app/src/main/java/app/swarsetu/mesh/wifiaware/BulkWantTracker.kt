 ...
 * [app.swarsetu.mesh.MeshTransport.expectBulkTransfer] on the Wi-Fi Aware plane. A noted peer counts as
 ...
 * JVM-unit-tested ([app.swarsetu.BulkWantTrackerTest]); `@Synchronized` for the transport's
