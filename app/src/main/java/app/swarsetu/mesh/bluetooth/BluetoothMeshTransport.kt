package app.swarsetu.mesh.bluetooth
...
import app.swarsetu.mesh.ConnectFailReason
...
import app.swarsetu.mesh.power.PowerPolicy
 ...
 * [app.swarsetu.mesh.wifiaware.WifiAwareTransport] behind [app.swarsetu.mesh.CompositeMeshTransport].
...
class BluetoothMeshTransport(
    ...
    private fun registerLink(
        ...
        link: app.swarsetu.mesh.link.LinkSocket,
    ) {
        val framed =
            FramedLink(
                nodeId = nodeId,
