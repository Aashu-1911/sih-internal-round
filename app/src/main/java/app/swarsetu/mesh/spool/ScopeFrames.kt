 ...
 * mesh bridge, the way [app.swarsetu.mesh.ForwardSync] injects its `authenticate` hook.
 */
object ScopeFrames {
     ...
     * [app.swarsetu.mesh.ForwardSync.onDigest] stamps when it re-serves to a neighbor.
     */
