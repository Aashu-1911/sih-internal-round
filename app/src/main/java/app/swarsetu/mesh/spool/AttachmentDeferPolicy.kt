 ...
 * fixtures and this class stays free of Room, Android and [app.swarsetu.mesh.MeshTransport].
 *
 ...
 * the blob rides a separate demand-driven [app.swarsetu.mesh.BlobExchange] fetch, not the frame.
 * The two conditions do different jobs and both are needed:
 *
 * - **[reachable] is the presence plane** ([app.swarsetu.mesh.MeshTransport.reachable]), which is
