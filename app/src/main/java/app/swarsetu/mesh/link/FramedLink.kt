package app.swarsetu.mesh.link

import app.swarsetu.mesh.DropReason
...
import app.swarsetu.mesh.isValidBlobHash
 ...
 * both [app.swarsetu.mesh.wifiaware.WifiAwareTransport] and the Bluetooth transport supply an impl that
 ...
 * JVM-unit-testable over a piped [LinkSocket] ([app.swarsetu.FramedLinkTest]). Callers pass
