...
import app.swarsetu.data.message.withReply
...
import app.swarsetu.mesh.protocol.FrameId
...
import app.swarsetu.mesh.protocol.isStorable
...
import app.swarsetu.notifications.NotifConversation
...
class InboundPipeline(
    ...
    /**
     * Verifies a profile's ratchet [app.swarsetu.mesh.protocol.PrekeyInfo] against the sender's
    ...
    private fun verifiedPrekey(
        ...
        pubKey: String,
        senderId: String,
    ): app.swarsetu.mesh.protocol.PrekeyInfo? {
