 ...
 * [app.swarsetu.demo.DemoDirector] (debug-only) emits commands; a `BuildConfig.DEMO_DIRECTOR`-gated
 ...
 *
 * Lives in `src/main` (like [app.swarsetu.ui.share.ShareInbox]) so `ChatScreen` can reference it in
