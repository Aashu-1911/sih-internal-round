 ...
 */
private fun isObfuscated(): Boolean = CrashEnvironment::class.java.name != "app.swarsetu.crash.CrashEnvironment"
 ...
 *
 * This is the single definition of the path, called both from `SwarSetuApplication.onCreate` (before Koin
