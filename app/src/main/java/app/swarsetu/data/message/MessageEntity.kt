package app.swarsetu.data.message
 ...
 * bytes live in the encrypted `blobs` table (see [app.swarsetu.data.blob.BlobEntity]), keyed by
 ...
 * [app.swarsetu.mesh.protocol.ReplyRef] so the quote renders even when the original was never
 ...
 * derived from the audio itself by [app.swarsetu.data.VoiceAudio] (the sender at ingest, the recipient
