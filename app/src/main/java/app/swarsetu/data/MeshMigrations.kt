...
/**
 * The registry of tested schema migrations applied in [MeshDatabase.build].
 *
 ...
 * `MeshDatabaseMigrationTest`) instead of silently wiping user data. So this is the single place production
 ...
 * the `MeshDatabaseMigrationTest` harness), and fill in a migration-test case per bump.
 */
object MeshMigrations {
    /**
     ...
     * themselves by [app.swarsetu.data.VoiceAudio], on the sender at ingest and on the recipient once the
