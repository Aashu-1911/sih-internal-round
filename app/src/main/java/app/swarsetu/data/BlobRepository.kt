 ...
 * classifier, caching verdicts) lives in [app.swarsetu.moderation.ImageScreeningService]; this class
...
class BlobRepository(
     ...
     * via a later [app.swarsetu.mesh.BlobExchange] re-pull. The own-avatar guard reads DataStore,
     ...
     * The eager carrier-pull ([app.swarsetu.mesh.InboundPipeline.onCarriedFrame]) uses this as a pull-time
