 ...
 * receive paths in [app.swarsetu.mesh.MeshManager] share one definition of "newer wins".
 */
class ReactionRepository(
     ...
     * (out-of-order mesh delivery) isn't reaped — see [app.swarsetu.data.reaction.ReactionEntity].
     */
