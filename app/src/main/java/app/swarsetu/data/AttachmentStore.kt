 ...
 * [app.swarsetu.data.blob.BlobEntity]). The content hash both keys the blob and is the key carried
 ...
 * are re-encoded to a smaller **animated WebP** via [app.swarsetu.data.webp.WebpTranscode] (VP8
