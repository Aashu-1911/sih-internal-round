package app.swarsetu.data.group
 ...
 * [app.swarsetu.data.message.Conversations.groupIdFor]) and carried on every group message (it
 * doubles as the message [app.swarsetu.data.message.MessageEntity.conversationId]). [name] is the
 * explicit group name, or blank (`""`) when unnamed — an unnamed group's title is generated locally per
 * device from its members (see [app.swarsetu.data.message.groupTitle]). [nameUpdatedAt] is the
 ...
 * [app.swarsetu.data.message.MentionStore].
 */
