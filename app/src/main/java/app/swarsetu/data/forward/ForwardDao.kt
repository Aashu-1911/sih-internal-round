 ...
 * [app.swarsetu.mesh.StoreDigest] content digest, which needs the expiry alongside the id to drive its
...
interface ForwardDao {
     ...
     * side of the "still-missing blobs" set (mirrors [app.swarsetu.data.message.MessageDao.hashesNeedingFetch]).
