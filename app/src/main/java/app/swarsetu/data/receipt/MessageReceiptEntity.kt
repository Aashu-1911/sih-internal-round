package app.swarsetu.data.receipt
 ...
 * receipt arrived on, first-evidence-wins like [app.swarsetu.data.message.MessageDao.markReceived]'s.
 *
 * There is deliberately no foreign key to `messages` (the [app.swarsetu.data.reaction.ReactionEntity]
