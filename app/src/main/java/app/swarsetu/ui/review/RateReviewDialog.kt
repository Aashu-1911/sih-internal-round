 ...
 * source repo, see [app.swarsetu.review] `ReviewPrompter.rateUrl`); [onNegative] routes a lukewarm one
 * to private feedback (the issue tracker) instead of a public 1-star review; [onDismiss] (tap-away / back)
 * just closes it. Stateless — the show/hide flag lives in `SwarSetuApp`, driven by [ReviewPromptInbox], and the
