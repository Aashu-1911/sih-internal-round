package app.swarsetu.ui.contacts
...
class ContactsViewModel(
     ...
     * renders its own default from the members; see [app.swarsetu.data.message.groupTitle]) until
     * someone renames it. Emits on [created] only after the row exists (no startup race in
     * [app.swarsetu.ui.chat.ChatViewModel]); members learn of a new group on its first message.
     */
