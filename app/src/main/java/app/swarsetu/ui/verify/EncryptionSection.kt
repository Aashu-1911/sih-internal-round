...
package app.swarsetu.ui.verify
...
import app.swarsetu.ui.image.QrCode
 ...
 *  - a peer's read-only profile ([app.swarsetu.ui.profile.ProfileDetailsScreenContent]) passes a
 *    non-null [peer] and shows the full verification section; and
 *  - the standalone Verify-contact screen ([app.swarsetu.ui.verify.VerifyContactScreenContent])
