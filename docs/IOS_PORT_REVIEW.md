...
- **Service-name format.** Info.plist `WiFiAwareServices` names are `_name._proto`, ≤15 chars,
  letters/numbers/dashes. `app.swarsetu.MESH.v6` (24 chars, dots) can't be declared on iOS at
